...
- `index.html` - React app entry point for GitHub Pages.
- `src/app.js` - React components, navigation, application ranking logic, and page content.
- `src/styles.css` - responsive styling for the React version.
- `assets/images/` - image assets reused from the coursework project.
